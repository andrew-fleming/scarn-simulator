...
class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      _computeOwnerCommitment: (...args_1) => {
        ...
        if (!(id_0.buffer instanceof ArrayBuffer && id_0.BYTES_PER_ELEMENT === 1 && id_0.length === 32))
          __compactRuntime.type_error('_computeOwnerCommitment',
                                      ...
                                      'Bytes<32>',
                                      id_0)
        if (!(typeof(counter_0) === 'bigint' && counter_0 >= 0 && counter_0 <= 18446744073709551615n))
          __compactRuntime.type_error('_computeOwnerCommitment',
      ...
      _computeOwnerId: (...args_1) => {
        if (args_1.length !== 3)
          throw new __compactRuntime.CompactError(`_computeOwnerId: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        const contextOrig_0 = args_1[0];
        const pk_0 = args_1[1];
        ...
        const partialProofData = {
          input: {
            value: _descriptor_4.toValue(pk_0).concat(_descriptor_1.toValue(nonce_0)),
        ...
        const result_0 = this.#__computeOwnerId_0(context,
                                                  partialProofData,
                                                  pk_0,
                                                  nonce_0);
        partialProofData.output = { value: _descriptor_1.toValue(result_0), alignment: _descriptor_1.alignment() };
  ...
  #_assertOnlyOwner_0(context, partialProofData) {
    ...
    const id_0 = this.#__computeOwnerId_0(context,
                                          partialProofData,
                                          callerAsEither_0,
                                          nonce_0);
  ...
  #__computeOwnerId_0(context, partialProofData, pk_0, nonce_0) {
...
const pureCircuits = {
  _computeOwnerId: (...args_0) => _dummyContract.circuits._computeOwnerId(_emptyContext, ...args_0).result
};
