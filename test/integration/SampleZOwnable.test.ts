...
import { SampleZOwnablePrivateState } from '../fixtures/sampleContracts/witnesses/SampleZOwnableWitnesses.js';
  ...
  describe('after initialization', () => {
    ...
    describe('_computeOwnerId', () => {
      ...
      it('should fail to compute ContractAddress id', () => {
        ...
        }).toThrow('SampleZOwnable: contract address owners are not yet supported');
      });
    });
  });
});
